...
class _PrintScreenState extends State<PrintScreen> {
  ...
  Future<void> _loadFileInfo() async {
    try {
      ...
      // Get file info from API using service
      final fileData =
          await apiService.getFileForPrinting(fileId: widget.fileId);
      ...
      debugPrint('❌ Auth error loading file: $e');
    } catch (e) {
      setState(() {
  ...
  Future<void> _submitPrintJob() async {
    try {
      ...
      // Submit print job via service
      await apiService.submitPrintJob(
      ...
      debugPrint('❌ Auth error submitting print job: $e');
    } catch (e) {
      setState(() {
        errorMessage = e.toString();
        isSubmitting = false;
