...
class _PrintHistoryScreenState extends State<PrintHistoryScreen> {
  // Filters
  String _filterStatus = 'All'; // 'All', 'Accepted', 'Rejected'
  ...
  List<HistoryItem> get _filteredHistory {
    ...
    if (_filterStatus == 'Accepted') {
      return _history.where((h) => h.status == 'APPROVED').toList();
    }
                  ...
                  children: [
                    ...
                    LayoutBuilder(
                        builder: (context, constraints) {
                            ...
                            if (_filterStatus == 'Accepted') alignX = 0.0;
                    ...
                    Row(
                      children: [
                        ...
                        _buildFilterTabButton('Accepted', colors, isDark),
